...
#ifndef FEEDLINGBROADCAST_SWIFT_H
#define FEEDLINGBROADCAST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FeedlingBroadcast",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSObject;
SWIFT_CLASS("_TtC17FeedlingBroadcast13SampleHandler")
...
SWIFT_CLASS("_TtC17FeedlingBroadcast16WebSocketManager")
...
@interface WebSocketManager (SWIFT_EXTENSION(FeedlingBroadcast)) <NSURLSessionWebSocketDelegate>
